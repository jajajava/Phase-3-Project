...
Art.create(id: 8, title: "Man Looking at Painting of a Nude", medium: "silver gelatin print", description: "Taken in a Paris shop window in 1949.", image: "https://d7hftxdivxxvm.cloudfront.net/?resize_to=fit&width=668&height=800&quality=80&src=https%3A%2F%2Fd32dm0rphc51dk.cloudfront.net%2FhH6vbR98eZgiTwmzA6b3aA%2Fnormalized.jpg", price: 125, user_id: 4)
Art.create(id: 9, title: "Lord Foog the 2st", medium: "real life", description: "Real, this is real.", image: "https://i.kinja-img.com/gawker-media/image/upload/c_fill,f_auto,fl_progressive,g_center,h_675,pg_1,q_80,w_1200/47e45547bca943d1f14b998872d33fe2.jpg", price: 2000, user_id: 5)
