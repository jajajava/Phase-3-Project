...
User.create(id: 2, name: "Sarah Biffin", email: "sarahbiffing@gmail.com", username: "SarahBeefin", password: "ArtIsCool", bio: "Victorian English painter, born with no arms and vestigial legs")
